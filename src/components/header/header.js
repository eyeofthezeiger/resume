      ...
      <React.Fragment>
        <header id="home">
            ...
            <div className="banner-text">
                <h1 className="responsive-headline">Matthew Zeiger</h1>
                <h3>I'm a <span>software developer</span>, <span>recruiter</span> and <span>aspiring writer</span> honing my craft and searching for a new oppurtunity as a developer. Let's <a className="smoothscroll" href="#about">start scrolling </a>
